    ...
    return (
        <div className="min-h-screen">  
               <div className=" justify-center items-center md:flex md:justify-evenly mt-9">
                ...
                <button className="btn p-2 w-32 px-3 ml-28 font-bold text-white bg-orange-700">Payment</button>
               </div>
               <div className="mt-3">
      ...
      {/* row 1 */}
               {
                cart.map((item , index) =>  <tr key={item._id}>
                    ...
                    <td>{item.price}</td>
                    <th>
                      <button onClick={() => handleDeleted(item._id)} className="btn btn-ghost text-xl"><MdDeleteOutline /> </button>
                    </th>
                  </tr>)
               }
